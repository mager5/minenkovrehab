...
async function testCorrectedPaymentLink() {
  try {
    console.log('🔄 Тестирование исправленного API генерации платежных ссылок...');
    ...
    if (response.data.success && response.data.data.paymentUrl) {
      ...
      const expectedFormat = 'https://auth.robokassa.ru/Merchant/Index.aspx?MerchantLogin=Minenkov-2&OutSum=2950.00&invoiceID=837984789&Description=Абонемент+клуба+формула+движения&SignatureValue=8E86A9B01122AA2175F5405AE1532FAE&IsTest=1';
