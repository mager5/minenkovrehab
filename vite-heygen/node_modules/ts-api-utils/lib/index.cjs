...
function isUnparsedSyntheticReference(node) {
  return (
    node.kind === ts9__default.default.SyntaxKind.UnparsedSyntheticReference
  );
}
...
function isUnparsedSourceText(node) {
  return (
    ts9__default.default.isUnparsedPrepend(node) ||
    ts9__default.default.isUnparsedTextLike(node)
  );
}
