...
function isJsxTagNamePropertyAccess(node) {
  return (
    ts9.isPropertyAccessExpression(node) && // eslint-disable-next-line deprecation/deprecation -- Keep compatibility with ts < 5
    ...
    outer: switch (parent.kind) {
      ...
      case ts9.SyntaxKind.CallExpression:
        ...
        const propertySymbol =
          (_b =
            (_a = parameterSymbolLinks.type) == null
              ? void 0
              : _a.getProperties()) == null
            ? void 0
            : _b[argumentIndex];
...
var RootScope = class extends AbstractScope {
  ...
  addVariable(identifier, name, selector, exported, domain) {
    ...
    this.#innerScope.end((value, key) => {
      value.exported ||=
        this.#exportAll ||
        (this.#exports !== void 0 && this.#exports.includes(key.text));
  ...
  createOrReuseNamespaceScope(name, exported, ambient, hasExportStatement) {
    ...
    this.#innerScope.end((variable, key, scope) => {
      if (
        ...
        (!variable.exported &&
          (!this.#ambient ||
            (this.#exports !== void 0 && !this.#exports.has(key.text))))
      ) {
