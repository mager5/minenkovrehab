 ...
 * @param {number} [amount=2950] - Сумма платежа
...
if (require.main === module) {
  console.log('🏋️ Генератор ссылок оплаты для клуба "Формула движения"');
  console.log('=' .repeat(70));
  
  // Генерируем ссылку для абонемента
  const result = generateClubSubscriptionLink();
  ...
  console.log(`✅ Description: ${decodeURIComponent(url.searchParams.get('Description'))}`);
