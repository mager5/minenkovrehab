...
- [x] Настроить workflow на сборку и публикацию сайта при пуше в main

## 4. Включение GitHub Pages для репозитория
- [ ] Перейти в настройки репозитория на GitHub
- [ ] В разделе Pages выбрать ветку, из которой будет развертываться сайт (автоматически через GitHub Actions)
