export const aboutContent = {
  hero: {
    ...
    description: "Я — специалист по физической реабилитации с опытом более 8 лет. Помогаю людям восстанавливаться после травм, операций и хронических заболеваний опорно-двигательного аппарата. В своей работе использую научно обоснованные методики и индивидуальный подход к каждому клиенту."
  },
  mission: {
    title: "Моя миссия",
