...
const AboutColumn = () => {
  ...
  return (
    <div className='transform transition-all duration-500 hover:translate-y-[-5px]'>
      <h3 className="text-xl font-bold mb-6 text-white relative inline-block after:content-[''] after:absolute after:w-14 after:h-0.5 after:bg-accent after:left-0 after:bottom-[-10px]">
        Миненков <span className='text-accent'>Вадим</span>
      </h3>
      <p className='text-white mb-4 font-semibold' style={{ color: '#d1f3ea' }}>
        Профессиональный подход к тренировочному процессу с учетом
        индивидуальных особенностей. Помогаю восстановить подвижность, снизить
        дискомфорт и вернуть телу уверенность в движении.
      </p>
      <div className='flex space-x-4 mt-6'>
        <a
          ...
          onKeyDown={e =>
            handleKeyDown(e, () =>
              window.open('https://t.me/MV_Rehab', '_blank')
            )
          }
        >
          <svg
        ...
        <a
          ...
          onKeyDown={e =>
            handleKeyDown(e, () =>
              window.open('https://youtube.com/@mv_rehab', '_blank')
            )
          }
        >
          <svg
        ...
        <a
          ...
          onKeyDown={e =>
            handleKeyDown(e, () =>
              window.open(
                'https://dzen.ru/id/646ca9d1fc7bc51b6ac77784',
                '_blank'
              )
            )
          }
        ...
        <a
          ...
          onKeyDown={e =>
            handleKeyDown(e, () =>
              window.open('https://rutube.ru/channel/38070887', '_blank')
            )
          }
        >
          <svg
        ...
        <a
          ...
          onKeyDown={e =>
            handleKeyDown(e, () =>
              window.open('https://vk.com/minenkov_rehab', '_blank')
            )
          }
        >
          <svg
        ...
        <div className='flex items-center'>
          ...
          <a
            ...
            onKeyDown={e =>
              handleKeyDown(
                e,
                () => (window.location.href = 'tel:+79283287052')
              )
            }
          >
            +7 928 328-70-52
...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div
        className='absolute top-0 left-0 right-0 h-12 overflow-hidden'
        aria-hidden='true'
      >
        <svg
          xmlns='http://www.w3.org/2000/svg'
          ...
          className='absolute bottom-0 w-full h-12 transform rotate-180'
        >
          <path
            fill='#F9FAFC'
