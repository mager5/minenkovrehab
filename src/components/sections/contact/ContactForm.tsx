      ...
      {submitSuccess ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6" aria-labelledby="contact-form-heading">
          ...
          <button
            ...
            className={`
              w-full bg-primary text-white py-3.5 px-6 rounded-md font-medium transition-all duration-300
              ${!isSubmitting && consentChecked ? 'hover:bg-primary-dark hover:-translate-y-1 hover:shadow-lg' : ''}
