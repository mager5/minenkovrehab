      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <motion.div>
            ...
            >
              <div className='relative group w-full max-w-md lg:max-w-none'>
                ...
                <Image
                  src='/images/hero/blue-stripe.JPG'
            ...
            >
              <h3 className='flex items-center text-xl font-semibold text-primary mb-3'>
                <motion.div
                  ...
                  whileHover={{
                    scale: 1.1,
                    backgroundColor: 'rgb(209, 243, 234)',
                  }}
              ...
              <p className='text-dark'>{homeContent.about.priceDescription}</p>
            </motion.div>
        ...
        <div className='mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 text-center'>
          <Counter
            ...
            label={homeContent.stats.satisfiedClientsLabel}
            plus={true}
            delay={0}
          />
          <Counter
            value={homeContent.stats.consultations}
            label={homeContent.stats.consultationsLabel}
            plus={true}
            delay={0.1}
          />
          <Counter
            value={homeContent.stats.onlinePrograms}
            label={homeContent.stats.onlineProgramsLabel}
            plus={true}
            delay={0.2}
          />
          <Counter
            value={homeContent.stats.experience}
            label={homeContent.stats.experienceLabel}
            plus={true}
            delay={0.3}
          />
        </div>
