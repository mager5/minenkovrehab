    ...
    <div className="transform transition-all duration-500 hover:translate-y-[-5px]">
      ...
      <ul className="space-y-4" aria-labelledby="contacts-heading">
        ...
        <li className="flex items-start hover:translate-x-1 transition-all duration-300">
          ...
          <a 
            href="tel:+79615854288" 
            className="text-white hover:text-accent transition-all duration-300 font-semibold focus:outline-none focus:underline" 
            style={{color: '#d1f3ea'}} 
            aria-label="Позвонить по телефону +7 (961) 585-42-88"
            onKeyDown={(e) => handleKeyDown(e, () => window.location.href = 'tel:+79615854288')}
          >
            +7 (961) 585-42-88
          </a>
        </li>
        <li className="flex items-start hover:translate-x-1 transition-all duration-300">
          ...
          <a 
            href="mailto:minenkov.rehab@gmail.com" 
            className="text-white hover:text-accent transition-all duration-300 font-semibold focus:outline-none focus:underline" 
            style={{color: '#d1f3ea'}} 
            aria-label="Написать на email minenkov.rehab@gmail.com"
            onKeyDown={(e) => handleKeyDown(e, () => window.location.href = 'mailto:minenkov.rehab@gmail.com')}
          >
