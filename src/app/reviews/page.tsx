    ...
    <div className='flex flex-col min-h-screen overflow-x-hidden'>
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            custom={1}
          >
            Узнайте, как мои тренировочные программы помогли сотням людей
            вернуться к полноценной, физически активной жизни.
          </motion.p>
        </motion.div>
      </motion.section>
      ...
      >
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            Ваш отзыв поможет другим людям принять важное решение о своем
            здоровье и вдохновит их начать путь к восстановлению.
          </motion.p>
      ...
      >
        <div className='container mx-auto px-4 text-center'>
          <motion.h2
            ...
            transition={{ duration: 0.5 }}
          >
            Начните свой путь к восстановлению сегодня
          </motion.h2>
          <motion.p
            ...
            transition={{ duration: 0.5, delay: 0.1 }}
          >
            Присоединяйтесь к сотням довольных клиентов и сделайте первый шаг к
