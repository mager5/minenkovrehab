      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-8 bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1">Основное фото (портрет)</label>
            ...
            <div>
              <label className="block text-sm font-medium mb-1">Фоновое изображение (hero-секция)</label>
              <div className="flex items-center gap-4">
                {content.heroBg && (
                  <div className="relative w-32 h-32">
        ...
        <section className="mb-8 bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="space-y-4">
            {content.advantages.map((advantage: string, idx: number) => (
              <div key={idx}>
                <label className="block text-sm font-medium mb-1">Преимущество {idx + 1}</label>
                <input
                  type="text"
                  value={advantage}
          ...
          <div className="space-y-6">
            {content.certificates.map((cert: Certificate, idx: number) => (
              <div key={idx} className="border p-4 rounded-lg">
                <div className="mb-4">
                  <label className="block text-sm font-medium mb-1">Название сертификата</label>
                  <input
                    type="text"
                    value={cert.title}
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">Изображение сертификата</label>
                  <div className="flex items-center gap-4">
                    {cert.image && (
                      <div className="relative w-32 h-32">
