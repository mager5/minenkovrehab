...
export const metadata: Metadata = {
  ...
  description:
    'Профессиональный подход к физической реабилитации людей среднего и старшего возраста с травмами, операциями и дегенеративными изменениями. Онлайн-консультации, программы и протоколы восстановления.',
  keywords:
    'физическая реабилитация, реабилитолог, Миненков Вадим, восстановление, травмы, операции, дегенератика, онлайн-консультации, ФОРМУЛА ДВИЖЕНИЯ, реабилитационные протоколы',
