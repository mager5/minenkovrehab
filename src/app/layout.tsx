...
export const metadata: Metadata = {
  ...
  keywords: "физическая реабилитация, реабилитолог, Миненков Вадим, восстановление, травмы, операции, дегенератика, онлайн-консультации, онлайн-ведение, ФОРМУЛА ДВИЖЕНИЯ, реабилитационные протоколы",
  metadataBase: new URL('https://minekovrehab.ru'),
  applicationName: 'МиненковRehab',
  authors: [{ name: 'Вадим Миненков', url: 'https://minekovrehab.ru' }],
  creator: 'Вадим Миненков',
  publisher: 'МиненковRehab',
  formatDetection: {
    telephone: true,
    email: true,
    address: true,
