  ...
  useEffect(() => {
    ...
    const animations: AnimationExample[] = [
      ...
      },
      {
        id: 3,
        title: 'Массаж',
        description: 'Анимация процедуры массажа',
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-700 max-w-3xl mx-auto'>
            Примеры использования векторных Lottie-анимаций для создания
            интерактивных и эффектных элементов интерфейса
          </p>
                ...
                <div className='p-6'>
                  ...
                  <div className='flex space-x-4'>
                    <div className='text-sm text-gray-500'>
                      <span className='font-medium'>Hover</span> для
                      проигрывания
                    </div>
                  </div>
                </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-white p-6 rounded-lg shadow'>
              ...
              <p className='text-gray-700'>
                JSON-файлы анимаций намного меньше по размеру, чем видео или
                GIF, что ускоряет загрузку страниц
              </p>
            </div>
            ...
            <div className='bg-white p-6 rounded-lg shadow'>
              ...
              <p className='text-gray-700'>
                Возможность управлять воспроизведением, скоростью и другими
                параметрами анимации через JavaScript
              </p>
            </div>
            ...
            <div className='bg-white p-6 rounded-lg shadow'>
              ...
              <p className='text-gray-700'>
                Векторные анимации сохраняют качество при любом размере экрана и
                разрешении
              </p>
            </div>
          </div>
