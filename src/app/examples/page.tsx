...
const examplesList = [
  {
    ...
    title: 'Анимации',
    description:
      'Примеры использования библиотеки Framer Motion для создания анимаций интерфейса',
  ...
  },
  {
    ...
    description:
      'Векторные анимации с использованием библиотеки Lottie для создания сложных и легких анимаций',
  ...
  },
  {
    ...
    description:
      'Примеры оптимизации изображений для дисплеев с высоким разрешением',
    ...
    <div className='min-h-screen py-16 bg-gray-50'>
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          >
            Коллекция демонстрационных примеров технологий и компонентов,
          ...
          {examplesList.map((example, index) => (
            ...
            >
              ...
              <div className='p-6 bg-white'>
                ...
                <Link
                  href={example.path}
                  className={`inline-block border border-current px-4 py-2 rounded-md font-medium transition-colors text-${example.color?.split(' ')[0]?.replace('bg-', '') || 'primary'}`}
                >
                  Посмотреть пример
                </Link>
              </div>
